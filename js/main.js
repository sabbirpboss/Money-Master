...
if (typeof foodCost == "string" || typeof rentCost == "string" || typeof clothCost == "string") {
...
document.getElementById('saving-button').addEventListener('click', function () {
    ...
    const savingAmount = document.getElementById('saving-amount').innerText = savingCalculation;
...
const remainingBalance = document.getElementById('remaining-balance').innerText = remainingAmount;
})